...
<div class="container mx-auto px-4 py-6 text-gray-800">
    ...
    <div class="flex flex-col md:flex-row justify-between items-center gap-4 mb-4 no-print">
        <div class="relative w-full md:w-1/3">
            ...
            <input type="search" id="tableSearch" class="block w-full pl-10 pr-3 py-2.5 border border-gray-200 rounded-xl leading-5 bg-white placeholder-gray-500 focus:outline-none focus:placeholder-gray-400 focus:border-blue-500 focus:ring-1 focus:ring-blue-500 sm:text-sm shadow-sm" placeholder="Search categories...">
        </div>
        ...
        <div class="overflow-x-auto">
            <table class="min-w-full divide-y divide-gray-200" id="income-statement-table">
                ...
                <tbody id="report-table-body" class="bg-white divide-y divide-gray-200">
                     <tr>
                        <td colspan="3" class="px-6 py-10 text-center text-gray-500">Click Generate to load income data</td>
                    </tr>
                </tbody>
            </table>
        </div>
...
jQuery(document).ready(function($) {
    ...
    $('#search-form').on('submit', function(e) {
        ...
        $.ajax({
            ...
            data: ajaxData,
            beforeSend: function() {
                $('#report-table-body').html('<tr><td colspan="3" class="px-6 py-10 text-center text-gray-500"><i class="fa-solid fa-spinner fa-spin text-2xl text-indigo-500"></i><div class="mt-2 text-sm font-medium">Processing financial data...</div></td></tr>');
            },
