...
<div class="container mx-auto px-4 py-6 text-gray-800">
    <div class="flex justify-between items-center mb-6 no-print">
        <h1 class="text-2xl font-bold text-gray-800">Customer Payment Report</h1>
    </div>

    <!-- Filters -->
    <div class="bg-white rounded-lg shadow-sm p-5 mb-6 border border-gray-200 no-print">
        <form id="cp-search-form" class="grid grid-cols-1 md:grid-cols-5 gap-4 items-end">
            <div>
            ...
            <div class="relative">
                ...
                <div id="columnDropdown" class="hidden absolute right-0 mt-2 w-48 bg-white rounded-lg shadow-lg border border-gray-200 z-50">
                    <div class="p-3 space-y-2 text-sm">
                        ...
                        <label class="flex items-center cursor-pointer hover:bg-gray-50 p-1 rounded">
                            <input type="checkbox" class="column-toggle mr-2" data-column="1" checked> Sales Invoice No.
                        </label>
                        <label class="flex items-center cursor-pointer hover:bg-gray-50 p-1 rounded">
                            <input type="checkbox" class="column-toggle mr-2" data-column="2" checked> Payment Date
                        </label>
                        <label class="flex items-center cursor-pointer hover:bg-gray-50 p-1 rounded">
                            <input type="checkbox" class="column-toggle mr-2" data-column="3" checked> Customer ID
                        </label>
                        <label class="flex items-center cursor-pointer hover:bg-gray-50 p-1 rounded">
                            <input type="checkbox" class="column-toggle mr-2" data-column="4" checked> Customer Name
                        </label>
                        <label class="flex items-center cursor-pointer hover:bg-gray-50 p-1 rounded">
            ...
            <table class="min-w-full divide-y divide-gray-200 text-sm">
                <thead class="bg-indigo-500 text-white">
                    <tr>
                        ...
                        <th class="px-6 py-3 text-left text-xs font-medium uppercase tracking-wider">Sales Invoice No.</th>
                ...
                <tbody id="p-table-body" class="bg-white divide-y divide-gray-200">
                     <tr>
...
jQuery(document).ready(function($) {
    ...
    function calculateFooter() {
        let paid = 0;
        $('#p-table-body tr:visible').each(function() {
    ...
    $('#tableSearch').on('keyup', function() {
        ...
        $('#p-table-body tr').filter(function() {
    ...
    $('#cp-search-form').on('submit', function(e) {
        ...
        $.ajax({
            ...
            type: 'POST',
            data: {
                action: 'search_customer_payment_report',
            ...
            beforeSend: function() {
                $('#p-table-body').html('<tr><td colspan="9" class="px-6 py-10 text-center text-gray-500"><i class="fa-solid fa-spinner fa-spin text-2xl"></i><div class="mt-2">Loading...</div></td></tr>');
            },
            success: function(res) {
                $('#p-table-body').html(res);
                calculateFooter();
            }
        });
    });
    ...
    $('#printBtn').on('click', function() {
        ...
        printWindow.document.write('<html><head><title>Customer Payment Report</title>');
        ...
        printWindow.document.write('<h1>Customer Payment Report</h1>');
    ...
    function exportPDF() {
        ...
        doc.save('customer-payment-report.pdf');
    }
    ...
    function exportExcel() {
        ...
        XLSX.writeFile(wb, 'customer-payment-report.xlsx');
    }
    ...
    $('#csvBtn').on('click', function() {
        ...
        link.download = 'customer-payment-report.csv';
        link.click();
    });
});
</script>
