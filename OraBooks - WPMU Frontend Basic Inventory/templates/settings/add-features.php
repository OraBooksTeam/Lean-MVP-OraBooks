...
// Handle Form Submission (Simple PHP for now, can be AJAX later)
...
// Fetch Features
$features = $wpdb->get_results("SELECT * FROM $table_name WHERE module = 'inventory' ORDER BY sort_order ASC");
$parent_menus = $wpdb->get_results("SELECT id, menu_title FROM $table_name WHERE parent = 0 AND status = 1 AND module = 'inventory'");

?>

<div class="p-6 bg-white rounded-xl shadow-sm border border-gray-100">
    <div class="flex justify-between items-center mb-6">
        <h2 class="text-2xl font-bold text-gray-800">Manage Sidebar Features</h2>
        ...
        <form method="post" id="feature-form">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                ...
                <div>
                    ...
                    <input type="text" name="module" id="module" value="inventory" class="w-full p-2 border border-gray-300 rounded-md focus:ring-indigo-500 focus:border-indigo-500" placeholder="inventory">
                </div>
                <div>
