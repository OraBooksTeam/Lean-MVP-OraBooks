...
class Frontend_Inventory_Contacts
{
    ...
    public static function handle_delete_customer_pay()
    {
        ...
        $payment = $wpdb->get_row($wpdb->prepare("SELECT salespayment_id, payment, customer_id FROM $table WHERE id = %d", $id));
    ...
    public static function handle_delete_supplier_pay()
    {
        ...
        $payment = $wpdb->get_row($wpdb->prepare("SELECT purchasepayment_id, payment, supplier_id FROM $table WHERE id = %d", $id));
