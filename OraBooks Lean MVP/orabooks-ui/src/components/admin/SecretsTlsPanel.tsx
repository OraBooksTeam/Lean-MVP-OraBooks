...
export default function SecretsTlsPanel({ checks, secretsRotation, loading }: Props) {
 ...
 <div>
 <h3 className="text-sm font-semibold text-ink">Secrets &amp; TLS </h3>
 ...
 Run post-deploy verification from Settings to load checks.
 </p>
 ): (
 ...
 Runbook: docs/-secret-rotation-runbook.md (JWT 30d, encryption 90d, TLS &amp; DB SSL)
 </p>
 </div>
 </div>
 </div>
