  ...
  const sidebarContent = (
    <>
      ...
      <NavLinks
        ...
        activeClassName="-translate-y-[1px] bg-primary text-white shadow-[inset_0_1px_0_rgba(255,255,255,0.3),0_12px_24px_rgba(9,30,66,0.3),0_0_22px_rgba(26,105,180,0.6)]"
        inactiveClassName="bg-white/12 text-white/90 shadow-[0_6px_14px_rgba(9,30,66,0.22)] hover:bg-white/10 hover:text-white hover:shadow-[0_10px_20px_rgba(9,30,66,0.28)]"
      />
