...
.map((l) => ({
 ...
 <p>
 Create draft invoices, submit for approval, post to AR (auto-post configurable), record FIFO payments, and issue credit notes per.
 </p>
 </div>
...
...l,
 ...
 <p className="mb-4 text-sm text-slate-600">
 {creditNoteInvoice.invoice_number} — reduce invoice balance or write off per.
 </p>
 {error && <div className="mb-4 rounded-lg border border-red-200 bg-red-50 p-3 text-sm text-red-700">{error}</div>}
 <div className="grid gap-4">
 <Field label="Amount">
