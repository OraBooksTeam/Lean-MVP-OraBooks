...
export default function PartnerProgramPage {
 ...
 View earned commissions, escrow schedule, payout batches, and aging from.
 </p>
 <WpLink
 to="/commissions"
 ...
 <p className="mt-1 text-sm text-slate-600">Gross, transaction fee, and net payout per period (from ).</p>
 </div>
