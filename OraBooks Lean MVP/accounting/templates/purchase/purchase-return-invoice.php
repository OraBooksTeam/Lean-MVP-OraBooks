...
<div class="max-w-4xl mx-auto">
    ...
    <div class="flex justify-between items-center mb-6 no-print">
        <div class="flex items-center">
            <a href="?view=purchase-return-list" class="mr-4 text-gray-500 hover:text-gray-700 transition-colors">
                <i class="fa-solid fa-arrow-left text-xl"></i>
            </a>
            <h1 class="text-2xl font-bold text-gray-800">Purchase Return</h1>
        </div>
        <div class="flex gap-3">
            ...
            <button id="export-pdf" class="inline-flex items-center px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-all font-medium shadow-sm active:scale-95">
    ...
    <div id="invoice-render-area" class="bg-white shadow-xl rounded-2xl overflow-hidden border border-gray-100 mb-10">
        <!-- Top Gradient Bar -->
        <div class="h-2 bg-gradient-to-r from-blue-600 to-blue-500"></div>
        
        <div class="p-8 md:p-12">
            <!-- Header -->
            <div class="flex justify-between gap-8 mb-2">
                <div>
                    <h2 class="text-3xl font-black text-blue-600 mb-2 uppercase tracking-tighter">Purchase Return</h2>
                    ...
                    <div class="space-y-3">
                        ...
                        <div class="flex justify-between items-center">
                            <span class="text-sm text-gray-500">Payment Status:</span>
                             <span class="px-3 py-1 rounded-full text-xs font-bold <?php echo ($purchase->payment_status == 'Paid') ? 'bg-blue-100 text-blue-800' : 'bg-rose-100 text-rose-800'; ?>">
