...
<div class="max-w-4xl mx-auto">
    <div class="flex justify-between items-center mb-6 no-print">
        ...
        <div class="flex gap-2">
            ...
            <button id="export-pdf" class="px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors shadow-sm">
...
jQuery(document).ready(function($) {
    $('#export-pdf').on('click', function() {
        ...
        html2canvas(element, {
            ...
            pdf.save('SalesInvoice_<?php echo esc_js($sale->sales_code); ?>.pdf');
