 ...
 * - Customer active status read model (owned by )
 * - Escrow schedule creation on partner_attribution_verified
 * - Monthly accrual release (journal entries via )
 ...
 * Uses customers.is_active as the authoritative truth source.
 */
 ...
 */
 ...
 try {
 // Create journal entry via posting engine
 ...
 */
 ...
 /**
 * Build balanced journal lines for payout settlement ( webhook).
 ...
 */
 ...
 /**
 * Post a balanced journal in the platform system org via posting engine.
 */
 ...
 * not the partner's org (which has no CoA per ).
 */
 ...
 /**
 * Deprecated guard: forbids direct ledger/balance mutation outside the posting engine.
 */
 ...
 */
 ...
 // Block payout if org is on hold, fraud_freeze, or suspended (per spec)
 ...
 // Fire notification event for (direct, for immediate delivery)
 ...
 /**
 * ============================================================
 * SETTLE PAYOUT (Called from reconciliation)
 * ============================================================
 */
 ...
 /**
 * Record gateway fee bank charge after payout settlement ( follow-up webhook).
 * Dr Commission Fee Payable, Cr Bank.
 */
 ...
 */
 ...
 /**
 * Per-customer commission summary for dashboard table.
 */
