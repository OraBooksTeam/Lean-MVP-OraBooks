<?php
/**
 * OraBooks Expenses OCR
 *
 * Receipt upload, MVP OCR extraction, confirm/submit routing to /,
 * approval and posting via.
 */
 ...
 */
 ...
 /**
 * OCR pipeline metrics for observability ( Phase 5).
 */
 ...
 */
 ...
 /**
 * Manual tax override for draft expenses.
 */
 ...
 */
 ...
 /**
 * Determine confirm/submit routing from OCR confidence and risk.
 *
...
: (current_user_can('manage_options')
 ...
 /**
 * Live readiness checks for (production smoke test).
 *
...
: 'Active provider: '. $ocr_provider
 ...
 $add('attachments_module', 'Attachments storage ', $has_attachments);
 }
