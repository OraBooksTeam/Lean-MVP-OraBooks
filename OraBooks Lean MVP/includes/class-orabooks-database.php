...
class OraBooks_Database {
 ...
 // ============================================================
 //: partner_reactivation_reviews table
 // ============================================================
 ...
 // ============================================================
 //: users table extensions (custom table for OraBooks users)
 // ============================================================
 ...
 //: extend users table for partner signup metadata and password reset tokens
 ...
 // ============================================================
 //: ledger_entries table (immutable posting record)
 // ============================================================
 ...
 // ============================================================
 //: journal_approval_history table (append-only)
 // ============================================================
 ...
 // ============================================================
 //: state_machine_transitions table
 // ============================================================
 ...
 // ============================================================
 // Add missing columns to outbox_messages table for EventBus
 ...
 // Extend ENUM to include 'dead_letter' needed by EventBus
 ...
 /**
 * guardrails for existing installs where dbDelta cannot alter ENUMs reliably.
 */
 ...
 /**
 *: DB-level immutability for audit_logs (archival bypass via session var).
 */
 ...
 /**
 * guardrails that dbDelta cannot express reliably.
 *
 ...
 */
 ...
 /**
 *: block line mutations that would leave a controlled journal unbalanced.
 */
