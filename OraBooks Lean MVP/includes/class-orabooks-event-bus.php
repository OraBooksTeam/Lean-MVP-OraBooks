<?php
/**
 * OraBooks Event Bus & Domain Events (SL-302)
 *
 ...
 * consumer registry, and SL-250 monitoring alerts.
 *
 * Key flows:
...
class OraBooks_EventBus {
    ...
    public static function register_consumers() {
        ...
        // payout_batch_created → SL-250 notification
        ...
        // payout_settled → SL-250 notification
    ...
    /**
     * Monitor event bus health and alert via SL-250 if needed.
     */
    public function monitor_health() {
        ...
        if ($pending_count > 100) {
            ...
            // Fire hook for SL-250 notification
     ...
     * (outbox_messages table is already created by SL-001)
     */
