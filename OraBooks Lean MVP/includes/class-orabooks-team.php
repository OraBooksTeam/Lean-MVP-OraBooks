 ...
 */
 ...
 $from_email = function_exists('get_option') ? get_option('admin_email'): '';	if (function_exists('is_multisite') && is_multisite() && function_exists('get_site_option')) {
 ...
 /**
 * Preview a pending invite without accepting it.
 */
 ...
 /**
 * Accept the newest pending invite for a registered user ( Option A: invite-first onboarding).
 *
 ...
 */
 ...
 // Revoke refresh tokens for this user in this org ( permission cache invalidation).
