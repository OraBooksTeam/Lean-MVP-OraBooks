 ...
 */
 ...
 /**
 * Auto-accept a pending team invite and issue a tenant session ( Option A).
 *
 * @param object $user
...
: false;
 ...
 sanitize_text_field($_POST['otp_code'] ?? ''),
 sanitize_text_field($_POST['backup_code'] ?? '')
 );
 ...
 */
 ...
 // User doesn't exist ΓÇö create account via Google
 $is_partner = ($user_type === 'partner') ? 1: 0;
 ...
 */
 ...
 /**
 *: block partner org REST accounting routes at ingress.
 */
 ...
 /**
 * requireCustomerOrg middleware ΓÇö blocks partner orgs and inactive orgs from accounting APIs
 *
 * Checks:
