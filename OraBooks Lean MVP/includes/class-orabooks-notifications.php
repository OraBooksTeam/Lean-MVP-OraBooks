...
class OraBooks_Notifications {
 ...
 // Listen for partner commission events ( integration)
 ...
 // Listen for partner lifecycle events (/ integration)
 ...
 // Listen for export events ( integration)
 ...
 // Operational / projection alerts (, integration)
 ...
 // Listen for invoice events ( integration)
 ...
 add_action('wp_ajax_orabooks_notifications_retry_delivery', [self::$instance, 'ajax_retry_delivery']);
 ...
 add_action('wp_ajax_nopriv_orabooks_notifications_retry_delivery', [self::$instance, 'ajax_retry_delivery']);
 ...
 */
 ...
 /**
 * Handle payout_batch_created event from.
 ...
 */
 ...
 /**
 * Handle payout_settled event from.
 */
...
: sprintf(__('%s to %s', 'orabooks'), $agg['oldest'], $agg['newest']);
 ...
 // ================================================================
 // INVOICE EVENT HANDLERS ( Integration)
 // ================================================================

 /**
 * Handle invoice_created event from.
 ...
 */
 ...
 /**
 * Handle payment_recorded event from.
 ...
 */
 ...
 /**
 * Handle invoices_marked_overdue event from daily cron.
 ...
 */
 ...
 /**
 * Handle inventory_low_stock_alert from.
 ...
 */
 ...
 /**
 * Handle projection_integrity_failed from.
 ...
 */
 ...
 // ================================================================
 // EXPORT EVENT HANDLERS ( Integration)
 // ================================================================

 /**
 * Handle export_ready event from.
 ...
 */
 ...
 /**
 * Handle export_failed event from.
 ...
 */
 ...
 /**
 * Handle csv_import_completed from.
 */
 ...
 */
 ...
 /**
 * Handle csv_row_escalated from ( AI review placeholder).
 */
