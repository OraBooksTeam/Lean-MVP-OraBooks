...
<div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
    ...
    <div class="search-filter-bar mb-4 flex flex-col md:flex-row gap-3 items-stretch md:items-center justify-between">
        ...
        <div class="export-toolbar flex gap-2 flex-wrap">
            <button id="purchasependinglistPrintBtn" class="text-gray-700 bg-white border border-gray-300 hover:bg-gray-100 focus:ring-4 focus:ring-gray-200 font-medium rounded-lg text-sm px-3 py-2 transition-colors flex-1 sm:flex-none h-[42px]" title="Print">
                <i class="fa-solid fa-print mr-1"></i> <span class="hidden sm:inline">Print</span>
            </button>
            <button id="purchasependinglistPdfBtn" class="text-gray-700 bg-white border border-gray-300 hover:bg-gray-100 focus:ring-4 focus:ring-gray-200 font-medium rounded-lg text-sm px-3 py-2 transition-colors flex-1 sm:flex-none h-[42px]" title="Export to PDF">
                <i class="fa-solid fa-file-pdf mr-1 text-red-600"></i> <span class="hidden sm:inline">PDF</span>
            </button>
            <button id="purchasependinglistExcelBtn" class="text-gray-700 bg-white border border-gray-300 hover:bg-gray-100 focus:ring-4 focus:ring-gray-200 font-medium rounded-lg text-sm px-3 py-2 transition-colors flex-1 sm:flex-none h-[42px]" title="Export to Excel">
                <i class="fa-solid fa-file-excel mr-1 text-green-600"></i> <span class="hidden sm:inline">Excel</span>
            </button>
            <button id="purchasependinglistCsvBtn" class="text-gray-700 bg-white border border-gray-300 hover:bg-gray-100 focus:ring-4 focus:ring-gray-200 font-medium rounded-lg text-sm px-3 py-2 transition-colors flex-1 sm:flex-none h-[42px]" title="Export to CSV">
...
jQuery(document).ready(function($) {
    ...
    // Export Functions
    function getPurchasePendingTableData() {
        const data = [];
        const headers = [];
    ...
    // Print
    $('#purchasependinglistPrintBtn').on('click', function() {
        ...
        const tableData = getPurchasePendingTableData();
    ...
    // PDF
    $('#purchasependinglistPdfBtn').on('click', function() {
    ...
    // Excel
    $('#purchasependinglistExcelBtn').on('click', function() {
        const tableData = getPurchasePendingTableData();
    ...
    // CSV
    $('#purchasependinglistCsvBtn').on('click', function() {
        const tableData = getPurchasePendingTableData();
        ...
        a.href = url;
        a.download = 'pending-purchases.csv';
