...
<div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
    ...
    <div class="search-filter-bar mb-4 flex flex-col md:flex-row gap-3 items-stretch md:items-center justify-between">
        ...
        <div class="export-toolbar flex gap-2 flex-wrap">
            <button id="viewpurchasePrintBtn"
            ...
            <div class="relative">
                <button id="viewpurchaseColumnToggleBtn"
                ...
                <div id="viewpurchaseColumnDropdown"
                    ...
                    <div class="p-3 space-y-2">
                        <label class="flex items-center cursor-pointer hover:bg-gray-50 p-1 rounded">
                            <input type="checkbox" class="viewpurchase-column-toggle mr-2" data-column="0" checked> Date
                        </label>
                        <label class="flex items-center cursor-pointer hover:bg-gray-50 p-1 rounded">
                            <input type="checkbox" class="viewpurchase-column-toggle mr-2" data-column="1" checked> Code
                        </label>
                        <label class="flex items-center cursor-pointer hover:bg-gray-50 p-1 rounded">
                            <input type="checkbox" class="viewpurchase-column-toggle mr-2" data-column="2" checked> Supplier
                        </label>
                        <label class="flex items-center cursor-pointer hover:bg-gray-50 p-1 rounded">
                            <input type="checkbox" class="viewpurchase-column-toggle mr-2" data-column="3" checked> Qty
                        </label>
                        <label class="flex items-center cursor-pointer hover:bg-gray-50 p-1 rounded">
                            <input type="checkbox" class="viewpurchase-column-toggle mr-2" data-column="4" checked> Status
                        </label>
                        <label class="flex items-center cursor-pointer hover:bg-gray-50 p-1 rounded">
                            <input type="checkbox" class="viewpurchase-column-toggle mr-2" data-column="5" checked> Total
                        </label>
                        <label class="flex items-center cursor-pointer hover:bg-gray-50 p-1 rounded">
                            <input type="checkbox" class="viewpurchase-column-toggle mr-2" data-column="6" checked> Paid
                        </label>
                        <label class="flex items-center cursor-pointer hover:bg-gray-50 p-1 rounded">
                            <input type="checkbox" class="viewpurchase-column-toggle mr-2" data-column="7" checked> Payment
                        </label>
                    </div>
                </div>
            </div>
                        ...
                        <?php foreach ($purchases as $p): ?>
                            <tr class="hover:bg-gray-50 transition-colors">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-center text-sm font-medium">
                                    ...
                                    <?php if (Frontend_Accounting_Permissions::has_view_permission('purchase-ordered-list') && $p->purchase_status !== 'Received'): ?>
                                    ...
                                    <?php endif; ?>
                                    <?php if (Frontend_Accounting_Permissions::has_view_permission('purchase-pending-list') && $p->purchase_status !== 'Received'): ?>
...
<script>
    jQuery(document).ready(function ($) {
        ...
        // --- Column Visibility ---
        $('#viewpurchaseColumnToggleBtn').on('click', function (e) {
            e.stopPropagation();
            $('#viewpurchaseColumnDropdown').toggleClass('hidden');
        });

        $(document).on('click', function (e) {
            if (!$(e.target).closest('#viewpurchaseColumnToggleBtn, #viewpurchaseColumnDropdown').length) {
                $('#viewpurchaseColumnDropdown').addClass('hidden');
            }
        });

        $('.viewpurchase-column-toggle').on('change', function () {
        ...
        function getViewPurchaseTableData() {
            const data = [];
            const headers = [];
        ...
        // Print
        $('#viewpurchasePrintBtn').on('click', function () {
            ...
            const tableData = getViewPurchaseTableData();
        ...
        // PDF
        $('#viewpurchasePdfBtn').on('click', function () {
        ...
        // Excel
        $('#viewpurchaseExcelBtn').on('click', function () {
            const tableData = getViewPurchaseTableData();
        ...
        // CSV
        $('#viewpurchaseCsvBtn').on('click', function () {
            const tableData = getViewPurchaseTableData();
            let csv = '';
