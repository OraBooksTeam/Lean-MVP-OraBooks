...
<style>
    ...
    /* Custom color scheme */
    .custom-green-100 { background-color: #d4f1d4 !important; }
    .custom-green-500 { background-color: #39B54A !important; }
    .custom-green-600 { background-color: #2d9a3a !important; }
    .custom-green-700 { background-color: #237a2e !important; }
    .custom-green-text { color: #39B54A !important; }
    .custom-green-text-dark { color: #2d9a3a !important; }
    .custom-blue-600 { background-color: #1569B3 !important; }
    .custom-blue-700 { background-color: #125491 !important; }
    .custom-blue-text { color: #1569B3 !important; }
    .custom-border-green { border-color: #39B54A !important; }
    .custom-border-blue { border-color: #1569B3 !important; }
    .custom-shadow-green { box-shadow: 0 10px 15px -3px rgba(57, 181, 74, 0.2) !important; }
    .custom-shadow-blue { box-shadow: 0 10px 15px -3px rgba(21, 105, 179, 0.2) !important; }
</style>
...
<div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6 purchase-return-container">
    ...
    <div class="flex flex-col md:flex-row justify-between items-center mb-8 gap-4">
        <div class="flex items-center">
            ...
            <div>
                ...
                <p class="text-sm text-gray-500 mt-1">Update return details and process refunds</p>
            </div>
        </div>
    ...
    <form id="purchase-form" class="space-y-6">
        <input type="hidden" name="action" value="update_purchasereturn">
        <input type="hidden" name="security" value="<?php echo esc_attr($nonce); ?>">
        <input type="hidden" name="purchase_id" value="<?php echo esc_attr($purchase_id); ?>">

        <!-- Top Section: Details -->
        <div class="bg-gray-50 rounded-lg p-4 border border-gray-200">
            <h2 class="text-sm font-bold text-gray-400 uppercase tracking-widest mb-4">Purchase Details</h2>
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                <div>
                    <label class="block text-xs font-bold text-gray-600 uppercase mb-1">Purchase Code</label>
                    <input type="text" name="purchase_code" id="purchase_code" readonly
                        class="w-full rounded-lg border-gray-300 bg-gray-100 py-2 px-3 text-sm font-mono custom-green-text"
                ...
                <div>
                    ...
                    <div class="flex gap-2">
                        ...
                        <button type="button"
                            class="min-h-[25px] px-1.5 py-0.5 md:px-3 bg-green-50 custom-green-text rounded-lg hover:bg-green-100 border border-green-200 transition-colors text-[10px] md:text-base flex-shrink-0"
                ...
                <div>
                    <label class="block text-xs font-bold text-gray-600 uppercase mb-1">Purchase Date</label>
                ...
                <div>
                    ...
                    <input type="text" name="reference_no" id="reference_no"
                        class="w-full rounded-lg border-gray-300 py-2 px-3 text-sm" placeholder="Optional">
                </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 items-start">
                ...
                <div class="space-y-6">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <div class="flex rounded-lg shadow-sm overflow-hidden border border-gray-300">
                                <input type="number" step="0.01" name="other_charges_input" id="other_charges_input" value="0" class="w-1/2 border-0 focus:ring-0 focus:border-0 rounded-l-lg border-r border-gray-200 py-2.5 px-3">
                                <select name="other_charges_tax_id" id="other_charges_tax_id" class="w-1/2 border-0 focus:ring-0 focus:border-0 bg-gray-50 text-xs font-bold py-2.5">
                        ...
                        <div>
                            ...
                            <div class="flex rounded-lg shadow-sm overflow-hidden border border-gray-300">
                                <input type="number" step="0.01" id="discount_to_all_input" name="discount_to_all_input"
                                    value="0" class="w-1/2 border-0 focus:ring-0 focus:border-0 rounded-l-lg border-r border-gray-200 py-2.5 px-3 font-bold custom-green-text">
                    ...
                    <div>
                        ...
                        <textarea name="purchase_note" id="purchase_note" rows="4"
                            class="w-full rounded-xl border-gray-300 focus:ring-green-500 custom-border-green shadow-sm px-4 py-3"
            ...
            <div class="bg-white rounded-3xl p-8 text-gray-900 border border-gray-200 shadow-sm relative overflow-hidden group">
                 <div class="absolute -top-24 -right-24 w-64 h-64 custom-green-500 opacity-5 rounded-full blur-3xl group-hover:opacity-10 transition-opacity"></div>
                 <h2 class="text-sm font-bold uppercase tracking-[0.2em] mb-8 custom-green-text opacity-80 border-b border-gray-100 pb-4">Order Summary</h2>
                ...
                <div class="space-y-4 mb-8">
                    ...
                    <div class="flex justify-between items-center text-sm">
                        ...
                        <span class="font-black custom-green-text-dark">- <span id="discount_all_text">0.00</span></span>
                    </div>
                    <div class="flex justify-between items-center text-sm">
                    ...
                    <div class="pt-6 border-t border-gray-100 flex justify-between items-end">
                        <div>
                            <span class="block text-[10px] font-black uppercase tracking-[0.3em] custom-green-text mb-1">Grand Total</span>
                ...
                <div class="bg-gray-50 border border-gray-200 rounded-2xl p-6 mb-8 purchase-return-container">
                    <h3 class="text-[10px] font-black uppercase tracking-[0.2em] custom-green-text mb-4 flex items-center">
                        <i class="fa-solid fa-wallet mr-2"></i> Refund Details
                    </h3>
                    <div class="grid grid-cols-2 gap-4 mb-4">
                        <div>
                            <label class="block text-[10px] font-black text-gray-500 uppercase mb-2">Payment Type</label>
                        ...
                        <div>
                            <label class="block text-[10px] font-black text-gray-500 uppercase mb-2">Refund Amount</label>
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        <div>
                            <label class="block text-[10px] font-black text-gray-500 uppercase mb-2">Refund Account</label>
                        ...
                        <div>
                            ...
                            <input type="text" name="payment_note" id="payment_note"
                                class="w-full rounded-lg border-gray-200 bg-white text-gray-900 text-xs py-2 px-3 focus:ring-green-500 custom-border-green" placeholder="Reference...">
                        </div>
                    </div>
                </div>
                ...
                <button type="button" id="update-purchase"
                    ...
                    <i class="fa-solid fa-cloud-arrow-up mr-3"></i> Update Purchase Return
                </button>
            </div>
        </div>
    </form>
...
<script>
    jQuery(document).ready(function ($) {
        const container = $('#obn-view-edit-purchase-return');
        ...
        $.get(ajaxurl, { action: 'get_purchasereturn_details', id: purchase_id, security: nonce }, function (res) {
            if (res.success) {
                ...
                container.find('#page-loader').html('<div class="text-center p-8 bg-white rounded-xl shadow-lg border border-red-100"><i class="fa-solid fa-circle-exclamation text-rose-500 text-4xl mb-4"></i><p class="text-gray-800 font-bold">' + (res.data || 'Failed to load details') + '</p><a href="?view=purchase-return-list" class="mt-4 inline-block text-indigo-600 font-bold border-b-2 border-indigo-600">Back to List</a></div>');
            }
        }, 'json');
        ...
        function populateRow(row, item) {
            ...
            if (item.purchase_account_id) {
                ...
                const invAcc = row.find('.row-account-id option').filter(function () {
                    ...
                    return text === 'inventory' || text.endsWith(' - inventory') || text.indexOf('1100') !== -1;
                }).val();
        ...
        function bindRowEvents(row) {
            ...
            row.find('.row-item-search').autocomplete({
                source: function (request, response) {
                    $.post(ajaxurl, { action: 'search_purchasereturn_items', term: request.term, security: nonce }, function (res) {
                        if (res.success) {
        ...
        // Form Submission
        container.find('#update-purchase').on('click', function () {
            const btn = $(this);
            ...
            if (container.find('#items-tbody tr').length === 0) { alert('Your purchase is empty. Please add items.'); return; }
