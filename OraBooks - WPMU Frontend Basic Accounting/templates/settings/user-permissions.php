...
<div class="user-permissions-page">
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
        <div class="p-6 border-bottom bg-gray-50">
            <div class="max-w-md">
                <label for="permission-user-select" class="block text-sm font-semibold text-gray-700 mb-2">Select User</label>
                <select id="permission-user-select" class="w-full rounded-lg border-gray-300 focus:ring-blue-500 focus:border-blue-500 shadow-sm transition-all" style="width: 100% !important;">
                    <option value="">-- Choose a User --</option>
                    <?php foreach ($users as $user) : 
                        $display = !empty($user->display_name) ? $user->display_name : $user->user_login;
                    ?>
                        <option value="<?php echo $user->ID; ?>"><?php echo esc_html($display . ' (' . $user->user_email . ')'); ?></option>
                    <?php endforeach; ?>
                </select>
            </div>
        </div>
            ...
            <form id="user-permissions-form">
                ...
                <div class="mb-6 pb-4 border-b border-gray-100 flex items-center justify-between">
                    <label class="inline-flex items-center cursor-pointer group">
                        <input type="checkbox" id="select-all-permissions" class="w-6 h-6 text-blue-600 border-gray-300 rounded focus:ring-blue-500 transition-all">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                    <?php foreach ($grouped_items as $module => $parents) : ?>
                        <div class="module-section">
                            <h3 class="text-lg font-bold text-blue-800 mb-4 pb-2 border-b-2 border-blue-100 flex items-center">
                                    ...
                                    <div class="parent-item-group bg-slate-50 p-4 rounded-lg border border-slate-100">
                                        <div class="flex items-center mb-3">
                                            <label class="inline-flex items-center cursor-pointer">
                                                <input type="checkbox" name="sidebar_ids[]" value="<?php echo $parent['id']; ?>" class="parent-checkbox w-5 h-5 text-blue-600 border-gray-300 rounded focus:ring-blue-500">
                                            ...
                                            <div class="ml-8 grid grid-cols-1 gap-2 mt-2">
                                                <?php foreach ($parent['children'] as $child) : ?>
                                                    <label class="inline-flex items-center cursor-pointer p-1 hover:bg-white rounded transition-colors">
                                                        <input type="checkbox" name="sidebar_ids[]" value="<?php echo $child['id']; ?>" class="child-checkbox w-4 h-4 text-blue-500 border-gray-300 rounded focus:ring-blue-500">
    ...
    <div class="mt-8 bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
        <div class="p-6 border-b border-gray-100 flex justify-between items-center">
            ...
            <button id="refresh-permissions-list" class="text-blue-600 hover:text-blue-800 text-sm font-semibold flex items-center gap-1 transition-colors">
