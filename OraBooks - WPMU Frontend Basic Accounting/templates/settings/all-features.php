    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
        <?php foreach ($features as $f): ?>
            <div data-target="<?php echo esc_attr($f->menu_slug); ?>" 
                 class="obn-feature-card cursor-pointer group p-6 bg-slate-50 rounded-2xl border border-slate-100 hover:border-indigo-300 hover:bg-indigo-50 transition-all duration-300 flex flex-col items-center text-center">
