  ...
  jQuery(document).ready(function($){
    $('.add_variant').on('click', function(e){
        ...
        var data = {
            ...
            security: typeof Frontend_Accounting_ajax !== 'undefined' ? Frontend_Accounting_ajax.nonce : '<?php echo wp_create_nonce("frontend_ajax_nonce"); ?>'
        };

        var ajax_url = typeof Frontend_Accounting_ajax !== 'undefined' ? Frontend_Accounting_ajax.ajax_url : '<?php echo admin_url("admin-ajax.php"); ?>';
