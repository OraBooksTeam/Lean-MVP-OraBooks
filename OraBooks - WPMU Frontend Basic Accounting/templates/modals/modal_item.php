...
<!-- Item Modal -->
<div id="item-modal" class="fixed inset-0 z-[999999] hidden overflow-y-auto" aria-labelledby="modal-title" role="dialog"
    aria-modal="true">
            ...
            <form id="item-modal-form" enctype="multipart/form-data">
                ...
                <div class="bg-white px-8 py-6">
                    <div class="flex items-center justify-between mb-8 border-b border-gray-100 pb-5">
                        ...
                        <button type="button"
                            class="w-10 h-10 flex items-center justify-center rounded-full text-gray-400 hover:text-gray-600 hover:bg-gray-100 transition-all close-item-modal">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-x-6 gap-y-5">
                        ...
                        <div class="md:col-span-1">
                            ...
                            <input type="text" name="item_code" id="m_item_code" readonly
                        ...
                        <div>
                            <label class="block text-sm font-semibold text-gray-700 mb-1.5">Price (Excl. Tax) <span
                                    class="text-red-500">*</span></label>
                            <input type="number" step="0.01" name="price" id="m_price" required
                                class="w-full rounded-xl border-gray-200 focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 shadow-sm transition-all py-2 px-2.5"
                                placeholder="0.00">
                        </div>
                        ...
                        <div>
                            <label class="block text-sm font-semibold text-gray-700 mb-1.5">Tax <span
                                    class="text-red-500">*</span></label>
                            <select name="tax_id" id="m_tax_id"
                                class="w-full rounded-xl border-gray-200 focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 shadow-sm transition-all py-2 px-2.5">
                        ...
                        <div>
                            ...
                            <select name="tax_type" id="m_tax_type"
                                class="w-full rounded-xl border-gray-200 focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 shadow-sm transition-all py-2 px-2.5">
                        ...
                        <div>
                            ...
                            <input type="number" step="0.01" name="purchase_price" id="m_purchase_price" readonly
                        ...
                        <div>
                            ...
                            <input type="number" step="0.01" name="profit_margin" id="m_profit_margin"
                                class="w-full rounded-xl border-gray-200 focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 shadow-sm transition-all py-2 px-2.5"
                                placeholder="0.00">
                        </div>
                        ...
                        <div>
                            ...
                            <input type="number" step="0.01" name="sales_price" id="m_sales_price"
                                class="w-full rounded-xl border-gray-200 focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 shadow-sm transition-all py-2 px-2.5"
                                placeholder="0.00">
                        </div>
                ...
                <div class="bg-gray-50 px-8 py-5 flex items-center justify-end gap-4 border-t border-gray-100">
                    <button type="button"
                        class="close-item-modal px-6 py-2.5 text-sm font-bold text-gray-600 hover:text-gray-900 border border-gray-200 rounded-xl hover:bg-white hover:shadow-sm transition-all">
                        Cancel
                    </button>
                    <button type="submit" id="save-item-modal-btn"
