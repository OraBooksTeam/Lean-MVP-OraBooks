...
def build_document:
 ...
 " থেকে পর্যন্ত specification অনুযায়ী module implement করা হয়েছে।",
 )
 ...
 "Event table: {prefix}gob_*_tob । "
 "ACID transaction, FOR UPDATE lock ( workflow) এবং WordPress $wpdb integration-এর জন্য MySQL।",
 ),
 (
 ...
 (
 "Queue — Async Jobs + WordPress Cron",
 ...
 "Receipt OCR, Voice, Classification । "
 "API key না থাকলে MVP stub fallback deterministic result দেয়।",
 ),
 (
 "PWA — Service Worker + IndexedDB",
 "Mobile expense receipt offline queue । Service worker shell cache করে। "
 ...
 add_heading(doc, "১.৩ Domain Modules ( → )", 2)
 add_bullets(
 doc,
 [
 ...
 "Accounting software-এ secret leak মানে financial data compromise। সব key encrypt করে এবং production-এ TLS enforce করে।",
 ),
 (
