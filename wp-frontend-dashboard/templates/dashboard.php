...
<body class="h-full flex flex-col md:flex-row overflow-hidden">
    ...
    <aside class="hidden md:flex w-72 flex-col bg-premium-dark text-white p-6 shrink-0 z-50">
        ...
        <nav class="flex-1 space-y-1">
            ...
            <button onclick="loadSection('security')" data-section="security" class="nav-btn group flex items-center w-full gap-3 px-4 py-3 rounded-xl transition text-gray-400 hover:text-white hover:bg-white/5">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 15v2m0 0v2m0-2h2m-2 0H10m9.364-7.364A9 9 0 1112 3a9 9 0 019.364 9.364z"></path></svg>
    ...
    <div class="flex-1 flex flex-col h-full overflow-hidden relative">
        ...
        <nav class="md:hidden glass fixed bottom-0 left-0 right-0 h-20 px-6 flex items-center justify-between z-50 pb-[env(safe-area-inset-bottom)]">
            ...
            <button onclick="loadSection('security')" data-section="security" class="mobile-nav-btn flex flex-col items-center gap-1 text-gray-400">
                <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 15v2m0 0v2m0-2h2m-2 0H10m9.364-7.364A9 9 0 1112 3a9 9 0 019.364 9.364z"></path></svg>
                <span class="text-[10px] font-bold uppercase tracking-wider">Security</span>
            </button>
        </nav>
        ...
        <div id="mobile-sidebar" class="md:hidden fixed inset-0 z-[60] overflow-hidden pointer-events-none">
            ...
            <div class="absolute top-0 left-0 bottom-0 w-80 bg-premium-dark p-6 transform -translate-x-full transition-transform duration-300 pointer-events-auto" id="sidebar-content">
                ...
                <nav class="space-y-1" id="mobile-nav-container">
                    ...
                    <button onclick="loadSection('security')" data-section="security" class="mobile-nav-btn group flex items-center w-full gap-3 px-4 py-3 rounded-xl transition text-gray-400 hover:text-white hover:bg-white/5">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 15v2m0 0v2m0-2h2m-2 0H10m9.364-7.364A9 9 0 1112 3a9 9 0 019.364 9.364z"></path></svg>
                        <span class="font-medium">Security</span>
                    </button>
